...
/**
 * A class to contain the library configuration for the Livere API client.
 */
class Livere_Config
{
    ...
    /**
     * Create a new Livere_Config. Can accept an ini file location with the
    ...
    public function __construct($ini_file_location = null)
    {
        $this->configuration = array(
            ...
            'auth_class' => 'Livere_Auth_Simple',
            'io_class' => self::USE_AUTO_IO_SELECTION,
            'cache_class' => 'Livere_Cache_File',
            'logger_class' => 'Livere_Logger_Null',
            'classes' => array(
                'Livere_IO_Abstract' => array('request_timeout_seconds' => 100, ),
                'Livere_IO_Curl' => array(
                    'disable_proxy_workaround' => false,
                    'options' => null,
                ),
                'Livere_Logger_Abstract' => array(
                    'level' => 'debug',
                    'log_format' => "[%datetime%] %level%: %message% %context%\n",
                    'date_format' => 'd/M/Y:H:i:s O',
                    'allow_newlines' => true
                ),
                'Livere_Http_Request' => array(
