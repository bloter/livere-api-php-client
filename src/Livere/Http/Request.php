...
class Livere_Http_Request
{
    ...
    {
        $headers = Livere_Utils::normalize($headers);
    ...
    public function maybeMoveParametersToBody()
    {
        if ($this->getRequestMethod() == "POST" && empty($this->postBody)) {
            $this->setRequestHeaders(array("content-type" => "application/x-www-form-urlencoded; charset=UTF-8"));
