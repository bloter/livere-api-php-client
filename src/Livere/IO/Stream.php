...
/**
 * Http Streams based implementation of Livere_IO.
 *
 */
...
class Livere_IO_Stream extends Livere_IO_Abstract
{
    ...
    public function executeRequest(Livere_Http_Request $request)
    {
        ...
        if ($this->trappedErrorNumber) {
            ...
            throw new Livere_IO_Exception($error, $this->trappedErrorNumber);
        }
        ...
        if (false === $response_data) {
            ...
            $this->client->getLogger()->error('Stream ' . $error);
            throw new Livere_IO_Exception($error, $respHttpCode);
        }
